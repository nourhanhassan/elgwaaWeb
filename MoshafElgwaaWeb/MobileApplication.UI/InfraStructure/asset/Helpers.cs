...
namespace MobileApplication.UI.InfraStructure
{
    public static class MyHelpers
    {
        ...
        public static MvcHtmlString HtmlActionLink(this AjaxHelper helper, string Html, string actionName, object routeValues, AjaxOptions ajaxOptions, object htmlAttributes = null)
            {
                var link = helper.ActionLink("[replaceme]", actionName, routeValues, ajaxOptions, htmlAttributes).ToHtmlString();
                return MvcHtmlString.Create(link.Replace("[replaceme]", Html));
            }

        public static MvcHtmlString HtmlActionLink(this HtmlHelper helper, string Html, string actionName, object routeValues, object htmlAttributes = null)
        {
            var link = helper.ActionLink("[replaceme]", actionName, routeValues, htmlAttributes).ToHtmlString();
